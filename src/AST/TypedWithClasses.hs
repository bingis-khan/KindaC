...
type instance XLVar TC = (Def.UniqueVar, Type TC)  -- This is not that good..... probably TEMP
...
type instance XDataScheme TC = T.Scheme TC
...
type ClassInstantiationAssocs = Map Def.UniqueClassInstantiation [(Type TC, ([Type TC], InstFun TC), Int)]
data TypeAssociation = TypeAssociation (Type TC) (Type TC) (ClassFunDec TC) Def.UniqueClassInstantiation


data Mod = Mod
  { topLevelStatements :: [AnnStmt TC]
  , exports :: Exports TC
  , classInstantiationAssociations :: ClassInstantiationAssocs
  }
type instance Module TC = Mod
